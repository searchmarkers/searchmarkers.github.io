...
const getWordPatternStrings = (() => {
     ...
     */
    const sortCompareFnReverse = (a, b) => a > b ? -1 : 1;
    return (() => {
        const suffixes = [
            "rison",
            "risons",
            ...
            "encings",
            "ency",
            "", "s", "entual", "entuals", "entuality", "entualities",
            "ed",
            "er",
            "ers",
            "ern",
        ...
        const replacePatternReverse = new RegExp(`\\b(?:${suffixes.map(suffix => reverse(suffix)).sort(sortCompareFnReverse).join("|")})`, "gi");
